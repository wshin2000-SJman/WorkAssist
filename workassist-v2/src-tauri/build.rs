fn main() {
    tauri_build::try_build(
        tauri_build::Attributes::new()
            ...
            .plugin("minutes", tauri_build::InlinedPlugin::new().commands(&["get_meeting_count", "get_meetings", "save_meeting", "export_meeting_md", "export_minutes_md_bulk", "import_minutes_md_bulk", "save_text_file", "delete_meeting", "get_deleted_meetings", "restore_meeting", "hard_delete_meeting_cmd"]))
