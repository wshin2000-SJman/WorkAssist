fn main() {
    tauri_build::try_build(
        tauri_build::Attributes::new()
            ...
            .plugin("rag", tauri_build::InlinedPlugin::new().commands(&["invoke_sidecar_test", "index_parsed_specs", "search_specs", "generate_embeddings_test", "parse_excel", "get_pdf_files_in_folder"]))
